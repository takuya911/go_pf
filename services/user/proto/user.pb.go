...
func (x *GetUserResponse) GetDeletedAt() *timestamp.Timestamp {
	if x != nil {
		return x.DeletedAt
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x95, 0x02, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	...
	0x6d, 0x70, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0x47, 0x0a,
...
var file_user_proto_depIdxs = []int32{
	2, // 0: user.GetUserResponse.createdAt:type_name -> google.protobuf.Timestamp
	2, // 1: user.GetUserResponse.updatedAt:type_name -> google.protobuf.Timestamp
	2, // 2: user.GetUserResponse.deletedAt:type_name -> google.protobuf.Timestamp
